...
export function ChapterItem({ chapter, bookId, onDelete }: ChapterItemProps) {
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 px-3 py-2.5 bg-muted border border-white/60 rounded-lg",
    ...
    >
      ...
      <div className="flex items-center gap-2 flex-wrap pl-7 sm:pl-0 sm:shrink-0">
