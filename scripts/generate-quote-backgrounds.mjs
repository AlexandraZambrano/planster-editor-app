...
const outDir = join(root, "public/quote-backgrounds")
mkdirSync(outDir, { recursive: true })

const SIZE = 1080

// On-brand, generated gradients — no stock photography, so there's no
// licensing question. Each entry becomes public/quote-backgrounds/bg-N.jpg.
const backgrounds = [
